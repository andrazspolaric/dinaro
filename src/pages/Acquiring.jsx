...
function ModuleCard({ title, sub, href, logo, instructionsLabel }) {
	return (
		<div className="card pm__module-card">
			<div className="pm__module-thumb" style={logo ? { backgroundImage: `url(${logo})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' } : undefined} />
