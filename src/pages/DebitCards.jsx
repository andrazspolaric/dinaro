...
export default function DebitCards() {
	...
	const tabs = [
		{ id: 'individual', label: t('debitCards.tabs.individual') },
		{ id: 'business', label: t('debitCards.tabs.business') },
	];
	...
	const tabContent = t(`debitCards.${tabKey}`);
		...
		<div className="fp">
			...
			<div className="fp__hero">
				...
				<div className="fp__hero-text">
					<p className="fp__hero-title">{t('debitCards.heroTitle')}</p>
					<p className="fp__hero-subtitle">{t('debitCards.heroSubtitle')}</p>
				</div>
			</div>
